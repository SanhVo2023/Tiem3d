...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: socialCard("/assets/generated/products/product-gear.webp"),
        width: 1200,
        height: 630,
        alt: "In 3D Kỹ Thuật",
      },
  ...
  twitter: {
    ...
    images: [socialCard("/assets/generated/products/product-gear.webp")],
  },
  alternates: {
  ...
  return (
    <>
      <ServiceJsonLd
        ...
        description="Dịch vụ in 3D kỹ thuật với độ chính xác ±0.1mm. Phù hợp cho chi tiết cơ khí, lắp ghép chính xác, prototype kỹ thuật. Hỗ trợ file CAD, báo cáo QC đầy đủ."
        url="https://tiem3d.com/dich-vu/in-ky-thuat"
        image="https://tiem3d.com/assets/generated/products/product-gear.webp"
      />
      <BreadcrumbJsonLd
        items={[
