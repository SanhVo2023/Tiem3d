...
const processSteps = [
  { number: "01", title: "Xử lý bề mặt", description: "Loại bỏ layer lines, đánh nhám, làm phẳng bề mặt." },
  { number: "02", title: "Sơn & Phủ", description: "Sơn lót, sơn màu, sơn bóng. Airbrush hoặc sơn tay." },
  { number: "03", title: "Hiệu ứng đặc biệt", description: "Mạ chrome, vàng, đồng. Hiệu ứng weathering." },
  { number: "04", title: "Hoàn thiện", description: "Lắp ráp, đóng gói cẩn thận, giao hàng." },
];
      ...
      <main className="pt-16">
        ...
        <section className="relative py-24 px-6 md:px-12 overflow-hidden">
          ...
          <div className="relative z-10 max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-sm font-semibold tracking-[0.2em] uppercase text-orange-500 mb-4">Hoàn thiện</motion.p>
              <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-display text-4xl md:text-5xl lg:text-6xl text-zinc-900 mb-6">
                SƠN & HẬU KỲ<br /><span className="text-gradient">CHUYÊN NGHIỆP</span>
              </motion.h1>
              <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="text-lg text-zinc-600 mb-8">
                Biến sản phẩm in 3D thô thành tác phẩm hoàn chỉnh. Xử lý bề mặt, sơn màu, mạ kim loại.
              </motion.p>
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} className="flex gap-10 mb-8">
                {[{ value: "100+", label: "Dự án" }, { value: "Pro", label: "Airbrush" }, { value: "Chrome", label: "Plating" }].map((stat) => (
        ...
        <section ref={ref} className="py-20 px-6 md:px-12 bg-zinc-50">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-display text-3xl md:text-4xl text-zinc-900">QUY TRÌNH HOÀN THIỆN</h2>
            </div>
        ...
        <section className="py-20 px-6 md:px-12">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-display text-3xl md:text-4xl text-zinc-900">BEFORE & AFTER</h2>
            </div>
        ...
        <section className="py-20 px-6 md:px-12 bg-zinc-900">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-display text-3xl md:text-4xl text-white mb-6">CẦN HOÀN THIỆN?</h2>
            <p className="text-zinc-400 mb-8">Gửi sản phẩm cần xử lý - nhận báo giá chi tiết</p>
            <Link href="/bao-gia" className="inline-flex items-center gap-2 px-8 py-4 bg-orange-500 text-white text-sm font-bold tracking-wide rounded-full hover:bg-orange-600 transition-colors">BÁO GIÁ NGAY →</Link>
          </div>
        </section>
      </main>
